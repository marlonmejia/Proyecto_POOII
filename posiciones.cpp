...
int main()
{
    ...
    sf::Texture dado;
    sf::Font fuente;
    if(!fuente.loadFromFile("C:/Users/MARLON MEJIA/CLionProjects/Proyecto/arial.ttf")){
        return EXIT_FAILURE;
    }
    if(!tablero.loadFromFile("C:/Users/MARLON MEJIA/CLionProjects/Proyecto/tablero.jpg")){
        return EXIT_FAILURE;
    }
    if(!dado.loadFromFile("C:/Users/MARLON MEJIA/CLionProjects/Proyecto/dado.png")){
        return EXIT_FAILURE;
    }
    sf::Text texto1;
    sf::Text texto2;
