...
void Game::Run(int njugadores) {
    this->CANTIDAD_JUGADORES=njugadores;
    ...
    for(int i=0;i<CANTIDAD_JUGADORES;i++){
        switch (i){
            case 0:
                jugadores[(NumeroJugada+i)%CANTIDAD_JUGADORES].setJugar(true);
                break;
            case 1:
                jugadores[(NumeroJugada+i)%CANTIDAD_JUGADORES].setJugar(false);
                 break;
            case 2:
                jugadores[(NumeroJugada+i)%CANTIDAD_JUGADORES].setJugar(false);
                break;
